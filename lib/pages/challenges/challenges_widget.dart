                  ...
                  children: [
                    ...
                    StreamBuilder<List<ChallengesRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<ChallengesRecord> columnChallengesRecordList =
                            snapshot.data!;
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          children: List.generate(
                              columnChallengesRecordList.length, (columnIndex) {
                            final columnChallengesRecord =
                                columnChallengesRecordList[columnIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  10.0, 0.0, 10.0, 0.0),
                              child: FFButtonWidget(
                                ...
                                text: columnChallengesRecord.title!,
                      ...
                      children: [
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'Aditya\'s 100 pushup challenge',
                            options: FFButtonOptions(
                              width: 428.0,
                              height: 40.0,
                              padding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: 'FitSpark: Weekly Challenge',
                            options: FFButtonOptions(
                              width: double.infinity,
                              height: 40.0,
                              padding: EdgeInsetsDirectional.fromSTEB(
